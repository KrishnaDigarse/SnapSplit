...
from app.schemas.settlement import SettlementCreate, SettlementResponse, GroupBalanceResponse
...
@router.get("/balances/{group_id}", response_model=List[GroupBalanceResponse])
def get_group_balances(
    ...
    return settlement_service.get_group_balances(db, current_user, group_id)
