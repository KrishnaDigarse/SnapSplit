    ...
    return (
        <Layout>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
                <Link to="/groups" className="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            ...
                            <p className="text-sm text-gray-600">{groups?.length || 0} active</p>
                        </div>
                    </div>
                </Link>

                <Link to="/friends" className="bg-white p-6 rounded-lg shadow hover:shadow-md transition-shadow">
                    <div className="flex items-center">
                        <div className="flex-shrink-0">
                            <svg className="h-8 w-8 text-primary-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="bg-white p-6 rounded-lg shadow">
                    <div className="flex items-center">
                        ...
                        <div className="ml-4">
                            <h3 className="text-lg font-semibold text-gray-900">All Settled</h3>
                            <p className="text-sm text-gray-600">No pending balances</p>
                        </div>
                    </div>
                </div>
            </div>
